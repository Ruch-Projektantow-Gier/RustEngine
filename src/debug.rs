    ...
    pub fn draw(&self, view: &glm::Mat4, proj: &glm::Mat4, from: &glm::Vec3, to: &glm::Vec3) {
        ...
        unsafe {
            ...
            self.gl.UniformMatrix4fv(
                self.gl
                    .GetUniformLocation(self.line_program.id(), view_name.as_ptr()),
                1,
                gl::FALSE,
                view.as_ptr(),
            );
            ...
            self.gl.UniformMatrix4fv(
                self.gl
                    .GetUniformLocation(self.line_program.id(), proj_name.as_ptr()),
                1,
                gl::FALSE,
                proj.as_ptr(),
            );
            ...
            self.gl.UniformMatrix4fv(
                self.gl
                    .GetUniformLocation(self.line_program.id(), model_name.as_ptr()),
                1,
                gl::FALSE,
                model.as_ptr(),
            );

            self.gl.DrawArrays(gl::LINES, 0, 2);
